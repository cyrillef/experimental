...
// const assembleMixinstemplate: string = `
// // do not edit this file
// // this file is generated by the build process
// /*jshint esversion: 9 */

// import { %%final.name%% } from '%%final.path%%';

// declare module '%%final.path%%' {

// 	interface %%final.name%% {
// 		%%final.interface%%
// 	}

// 	namespace %%final.name%% {
// 		%%final.static%%
// 	}
...
export const assembleMixinsWithDefinition: <TBase extends Constructor>(derivedCtor: TBase, constructors: any[]) => any
	= <TBase extends Constructor>(derivedCtor: TBase, constructors: any[]): any => {
		constructors.forEach((baseCtor: any) => {
			// Non-Statics
			Object.getOwnPropertyNames(baseCtor.prototype).forEach((name: PropertyKey): void => {
